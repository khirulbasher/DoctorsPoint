(function() {
    ...
    function stateConfig($stateProvider) {
        ...
        .state('account-info', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/account-info/account-infos.html',
        ...
        .state('account-info-detail', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/account-info/account-info-detail.html',
        ...
        .state('account-info-detail.edit', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/account-info/account-info-dialog.html',
        ...
        .state('account-info.delete', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/account-info/account-info-delete-dialog.html',
