...
class PostGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Post entity")
        ...
        .repeat(2) {
            ...
            .post("/api/posts")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "postCode":"SAMPLE_TEXT", "active":null, "latitude":"SAMPLE_TEXT", "longitude":"SAMPLE_TEXT", "lastModifiedBy":null, "lastModifyDate":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
